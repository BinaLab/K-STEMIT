"""Multi-branch K-STEMIT variants for experiments without physical input features."""
...
class IceSheetModel_Multibranch1(torch.nn.Module):
    def __init__(self, args):
        ...
        self.spectral_conv = GCNConv(7, args.DIMENSIONALITIES[0], improved=True)

        self.spatial_conv = SAGEConv(7, args.DIMENSIONALITIES[0])

        self.temporal_conv = TemporalConv(in_channels=1, out_channels=args.DIMENSIONALITIES[0], kernel_size=5)
    ...
    def forward(self, graph_collection):
        ...
        # clamp self.alpha and self.beta to be between 0 and 1
...
class IceSheetModel_Multibranch_ablation4(torch.nn.Module):
    def __init__(self, args):
        ...
        self.spectral_conv = GCNConv(7, args.DIMENSIONALITIES[0], bias=True, normalize='sym')
    ...
    def forward(self, graph_collection):
        ...
        h1 = self.lin1(h1)
        h1 = F.hardswish(h1)
        h1 = F.dropout(h1, p=0.8, training=self.training)
